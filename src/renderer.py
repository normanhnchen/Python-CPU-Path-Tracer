...
from src.path_tracer import path_trace
from src.denoiser import oidn_denoise
import src.math_utils as math_utils
import src.input_check as input_check
...
def start():
    ...
    # Build the scene.
    from src.scene_builder import scene as SCENE
